    ...
    <div className="home-site" id="top">
      ...
      <footer className="home-footer section-shell">
        <div className="home-footer-top">
          ...
          <div><a href={appStoreUrl}>App Store</a><a href="library.html">Mod library</a><a href="logo.html">Logo</a><a href="privacy.html">Privacy</a><a href="licenses.html">Licenses</a><a href="https://www.squatchcraft.com/phosphor.html">SquatchCraft</a></div>
        </div>
